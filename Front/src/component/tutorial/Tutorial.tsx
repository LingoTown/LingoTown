...
const Tutorial: React.FC = () => {
  ...
  const title:string[] = ["LingoTown", "키보드 조작편", "방향키", "스페이스바", "Ask키", "Start키", "Start Stop키", "Done키", "퀘스트편", "캐릭터 획득", "Free Talking편", "Start Talk 버튼", "Send 버튼", "Retry 버튼", "History 버튼", "End 버튼", "Topic 대화편", "Topic 버튼", "Listen Again 버튼", "Translate 버튼", "Help 버튼", "Start Talk 버튼", "End 버튼", "스피킹 학습편", "Mypage", "♥ Enjoy Lingo Town ♥"];
  ...
  return (
    ...
    >
      ...
      {/* 왼 / 이미지 / 오 */}
      <div  className='flex w-[100%] h-[100%] max-h-[300px]'>
        {/* 왼 */}
        <div
