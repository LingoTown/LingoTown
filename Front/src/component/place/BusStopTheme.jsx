...
import {BusStop} from "../../../public/map/busStop/BusStop";
import * as THREE from 'three';

export const BusStopTheme = () => {
  ...
  return(
    <>
      ...
      <Circle ref={foxCircleRef} args={[1, 32]} position={[1.5, 0.2, 2]} rotation={[-Math.PI / 2, 0, 0]} >
        <meshStandardMaterial attach="material" color="pink" side={THREE.DoubleSide} />
      </Circle>
      <Circle ref={rabbitCircleRef} args={[2, 32]} position={[-2, 0.2, -2]} rotation={[-Math.PI / 2, 0, 0]} >
        <meshStandardMaterial attach="material" color="wheat" side={THREE.DoubleSide} />
      </Circle>
      <primitive ref={humanRef} scale={1} position={[5, 0.1, 2]} rotation={[0, Math.PI, 0]} object={human.scene}/>
      <primitive scale={0.2} position={[1.5, 0.4, 2]} rotation={[0, 0, 0]} object={fox.scene}/>
      <primitive scale={0.2} position={[-2, 1, -2]} rotation={[0, 0, 0]} object={rabbit.scene} />
