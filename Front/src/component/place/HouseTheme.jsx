...
export const HouseTheme = () => {
  ...
  return(
    <>
      ...
      <Circle ref={foxCircleRef} args={[1, 32]} position={[1, 0.3, -1]} rotation={[-Math.PI / 2, 0, 0]} >
        <meshStandardMaterial attach="material" color="pink" side={THREE.DoubleSide} />
      </Circle>
      <Circle ref={rabbitCircleRef} args={[1, 32]} position={[3.5, 0.3, 3]} rotation={[-Math.PI / 2, 0, 0]} >
        <meshStandardMaterial attach="material" color="wheat" side={THREE.DoubleSide} />
      </Circle>
      <primitive ref={humanRef} scale={1} position={[5, 0.3, 2]} rotation={[0, Math.PI, 0]} object={human.scene}/>
      <primitive scale={0.2} position={[1, 0.5, -1]} rotation={[0, 0, 0]} object={fox.scene}/>
      <primitive scale={0.2} position={[3.5, 1.1, 3]} rotation={[0, 1, 0]} object={rabbit.scene} />
