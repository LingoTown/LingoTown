...
import {School} from "../../../public/map/school/School";
...
export const SchoolTheme = () => {
  ...
  return(
    <>
      ...
      <Circle ref={foxCircleRef} args={[3, 32]} position={[30, 0.1, 50]} rotation={[-Math.PI / 2, 0, 0]} >
        <meshStandardMaterial attach="material" color="pink" side={THREE.DoubleSide} />
      </Circle>
      <Circle ref={rabbitCircleRef} args={[3, 32]} position={[-30, 0.1,80]} rotation={[-Math.PI / 2, 0, 0]} >
        <meshStandardMaterial attach="material" color="wheat" side={THREE.DoubleSide} />
      </Circle>
      <primitive ref={humanRef} scale={1} position={[30, 0.1, 130]} rotation={[0, Math.PI, 0]} object={human.scene}/>
      <primitive scale={0.5} position={[30, 0.5, 50]} rotation={[0, 0, 0]} object={fox.scene}/>
      <primitive scale={0.5} position={[-30, 0.5, 80]} rotation={[0, 1, 0]} object={rabbit.scene} />
    </>
  )
} 
