...
export const ChurchTheme = () => {
  ...
  return(
    <>
      ...
      <Circle ref={rabbitCircleRef} args={[1, 32]} position={[-1.5, -14.8, 1.2]} rotation={[-Math.PI / 2, 0, 0]} >
        <meshStandardMaterial attach="material" color="wheat" side={THREE.DoubleSide} />
      </Circle>
      <primitive ref={humanRef} scale={1} position={[5, -14.8, 2]} rotation={[0, Math.PI, 0]} object={human.scene}/>
      <primitive scale={0.2} position={[5.5, -13.8, 0]} rotation={[0, -1, 0]} object={fox.scene}/>
      <primitive scale={0.2} position={[-1.5, -14.5, 1.2]} rotation={[0, 2, 0]} object={rabbit.scene} />
