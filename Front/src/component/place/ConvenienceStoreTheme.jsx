...
import {ConvenienceStore} from "../../../public/map/convenienceStore/ConvenienceStore";
import * as THREE from 'three';

export const ConvenienceStoreTheme = () => {
  ...
  return(
    <>
      ...
      <primitive ref={humanRef} scale={1} position={[5, 0, 2]} rotation={[0, Math.PI, 0]} object={human.scene}/>
