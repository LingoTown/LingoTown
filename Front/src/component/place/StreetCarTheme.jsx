...
import {StreetCar} from "../../../public/map/streetCar/StreetCar";
import * as THREE from 'three';

export const StreetCarTheme = () => {
  ...
  return(
    <>
      ...
      <Circle ref={foxCircleRef} args={[3, 32]} position={[-3.4, 1.1, 0]} rotation={[-Math.PI / 2, 0, 0]} >
        <meshStandardMaterial attach="material" color="pink" side={THREE.DoubleSide} />
      </Circle>
      <Circle ref={rabbitCircleRef} args={[3, 32]} position={[-6.4, 0.03, 9]} rotation={[-Math.PI / 2, 0, 0]} >
      ...
      <primitive scale={0.5} position={[-6.4, 0.53, 9.1]} rotation={[0, 0, 0]} object={rabbit.scene} />
    </>
  )
} 
