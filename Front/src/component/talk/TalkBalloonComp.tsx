    ...
    <>
      <div className="absolute bottom-4 left-4 right-4 min-h-[147px] bg-white bg-opacity-75 p-4 border border-gray-500 shadow-lg rounded-lg">
        <div className="flex items-center justify-center">
          {
            talkBalloon.isUser?
            <img src={talkBalloon.userImg} className="w-[110px] h-[110px] rounded-full" alt="rabbit" />
            :
            <img src={talkBalloon.npcImg} className="w-[110px] h-[110px] rounded-full" alt="rabbit" />
          }
