...
import { Church } from '../../../public/map/church/Church';
...
export const ChurchComp: React.FC = () => {
  //wall
  const container = [
    { size: [50, 10, 3], position: [4, 5, 13], wallKey: 'FW1', name: 'wall', mass:0}, // 
    { size: [3, 10, 35], position: [7, 5, -3], wallKey: 'RW1',  name: 'wall', mass:0}, // Right
    { size: [50, 10, 3], position: [-4, 5, -11], wallKey: 'BW1', name: 'wall', mass:0}, // Back
    { size: [3, 10, 40], position: [-21, 5, 3], wallKey: 'LW1', name: 'wall', mass:0}, // 
  ];
  ...
  return(
    <>
      ...
      <Church position={[1, 15.14, 1]}/>
      <Environment blur={1} background preset="night" />
      <Circle ref={chefCircleRef} args={[3, 32]} position={[-8.5, 0.53, 3]} rotation={[-Math.PI / 2, 0, 0]} >
      ...
      <primitive scale={1} position={[-8.5, 0.53, 3]} rotation={[0, -2, 0]} object={chefFile.scene}/>
      <Circle ref={customerCircleRef} args={[3, 32]} position={[2, 0.53, 1]} rotation={[-Math.PI / 2, 0, 0]} >
      ...
      <primitive scale={1} position={[2, 0.53, 1]} rotation={[0, -1.6, 0]} object={customerFile.scene} />
    </>
  )
} 
