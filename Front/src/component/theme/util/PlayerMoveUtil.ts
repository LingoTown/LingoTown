...
export const PlayerMove = (playerRef: any, playerApi: any,  keysPressed: any, camera: THREE.Camera, cameraOffset: any, container: any, setPlayerPosition: any, playerRotation: any, setPlayerRotation: any, isMove:any, deltaTime: number, activeAction: any, actions: any) => {
