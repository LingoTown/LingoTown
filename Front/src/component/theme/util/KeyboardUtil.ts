export const HandleKeyDown = (SetAction: (actionName: string, activeAction: any, actions: any) => void, keysPressed: any, activeAction: any, actions: any) => {
...
export const HandleKeyUp = (SetAction: (actionName: string, activeAction: any, actions: any) => void, keysPressed: any, activeAction: any, actions: any) => {
  return (event: KeyboardEvent): void => {
