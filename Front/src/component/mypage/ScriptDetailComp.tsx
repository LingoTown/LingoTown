                  ...
                  <div >
                    <div style={{marginLeft: "100px"}} className='flex flex-col font-[30] ml-5 text-blue-100 p-1 px-3 border-[1px] border-blue-100 rounded-[7px]' >
                      <div className='w-1/2 flex flex-row justify-between text-blue-200 mb-2'>
                        <div style={{width: "300px"}}>&nbsp;총점 : {savedata[index]?.overallScore !== null && savedata[index]?.overallScore !== undefined ? `${savedata[index]?.overallScore}점` : '  0점'}</div>&nbsp;&nbsp;&nbsp;|
                        <div style={{width: "400px"}}>&nbsp;&nbsp;&nbsp;유창성 : {savedata[index]?.fluencyScore !== null && savedata[index]?.fluencyScore !== undefined ? `${savedata[index]?.fluencyScore}점` : '  0점'}</div>&nbsp;&nbsp;&nbsp;|
                        <div style={{width: "400px"}}>&nbsp;&nbsp;&nbsp;정확도 : {savedata[index]?.integrityScore !== null && savedata[index]?.integrityScore !== undefined ? `${savedata[index]?.integrityScore}점` : '  0점'}</div>&nbsp;&nbsp;|
                        <div style={{width: "400px"}}>&nbsp;&nbsp;&nbsp;발음 : {savedata[index]?.pronunciationScore !== null && savedata[index]?.pronunciationScore !== undefined ? `${savedata[index]?.pronunciationScore}점` : '  0점'}</div>|
                        <div style={{width: "400px"}}>&nbsp;&nbsp;&nbsp;강세 : {savedata[index]?.rhythmScore !== null && savedata[index]?.rhythmScore !== undefined ? `${savedata[index]?.rhythmScore}점` : '  0점'}</div>
                      </div>
